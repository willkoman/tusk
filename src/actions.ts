...
export const ACTIONS: readonly ActionDef[] = [
  ...
  { id: "explainAnalyze", title: "Explain Analyze", category: "Query", defaultKey: null, scope: "global", enabled: (c) => c.connected && !c.running && c.canExplainAnalyze && c.canRunDatabase },
